...
\title{\Huge Documento Simples em \LaTeX}                  % tamanho Huge
\author{\textbf{Prof. Ausberto S. Castro Vera} \\          % negrito
	UENF - CCT - LCMAT \\
	\textit{Ci\^{e}ncia da Computa\c{c}\~{a}o} - Matem\'{a}tica - PROFMAT           % it\'{a}lico
}
\date{\today}    % data. Pode ser \date{Outubro, 2021}
