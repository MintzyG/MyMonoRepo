...
\draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]
        {\paperwidth}
        {\centering Introdu\c{c}\~{a}o \`{a} Linguagem FORTRAN\\[5pt] % Titulo Livro
...
\noindent Copyright \copyright\  2023 Aluno Fulano de Tal e Ausberto S. Castro Vera\\ % Copyright notice
